...
import com.androiddevs.mvvmnewsapp.packages.util.Constants
import com.androiddevs.mvvmnewsapp.packages.util.Constants.Companion.QUERY_PAGE_SIZE
import com.androiddevs.mvvmnewsapp.packages.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
            ...
            when(it){
                is Resource.Success -> {
                    ...
                    it.data?.let {newsResponse ->
                        ...
                        isLastPage = totalPage == viewModel.searchNewsPage
                        if(isLastPage){
